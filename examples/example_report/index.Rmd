...
Alignment based approaches are dominant in the genomics space for the most obvious reason: it is the most exact way to match new data to older existing linear DNA sequence formats namely genomic or transcriptomic FASTA files. However doing so requires the quadratic time complexity of the conventional seed-extension alignment strategies . 
