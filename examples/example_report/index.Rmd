...
From this point, profiles of the same k can be combined with the `kmerdb matrix` command, producing 'unnormalized' or 'normalized' data matrices. 
...
kmerdb matrix Normalized *.8.kdb  | kmerdb distance correlation STDIN > Cdiff_fidelity_Pearson_dist.8.tsv
...
kmerdb matrix Normalized *.8.kdb | kmerdb distance correlation STDIN | kmerdb distance euclidean STDIN | kmerdb matrix PCA -n 3 STDIN > Cdiff_fidelity_Euclidean_dist_of_pearson_then_PCA_n3.8.tsv
