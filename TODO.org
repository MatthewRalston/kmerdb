...
* Code questions today
** IndexErrors
** TypeErrors
** dtype coercion errors
** Why does my code produce errors during numerical conversion?
** Why is my code behaving in a way that confuses me?
** Why don't I have mechanisms to identify why the numerical casting through Python from the file format, the file on disk, the uh, the input dataset. The prioritized uh microbial species makeup.")
