...
* 6/11/24 - [Happy Anniv Al!] Index refactor, offset calculations, index table structure

** D2*, D2S, and D2 statistics/distances
** TODO Refactor fileutil/index modules to produce valid index data on file-read
** TODO Refactor distance.pyx, ensure it compiles and computes successfully
